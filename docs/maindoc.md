...
You can also download the GAweights file from the GitHub Georgia Project website.  There are two formats available.  The weights files are in HDF5, the default in Tensorflow, and ONNX, the cross-platform format.  Download the [HDF5 weights file](https://github.com/KatherineMossDeveloper/The-Georgia-Project/releases/download/v1.5.5/GAweights.h5) or the [ONNX weights file](https://github.com/KatherineMossDeveloper/The-Georgia-Project/releases/download/v1.5.5/GAweights.onnx) to the \inference folder where you downloaded the Georgia Project code on your PC.  
...
Finally, this plot is generated in the GAkmeansd3blocks.py file.  Below is a scatter plot from the D3Blocks library, which is an open-sourced project on GitHub.  I also am trying out a new color scheme.  For more, visit [D3Blocks](https://github.com/d3blocks/d3blocks).  
...
Step 1. download the code.  
   - Download the [source code ZIP file.](https://github.com/KatherineMossDeveloper/The-Georgia-Project/archive/refs/tags/v1.5.5.zip) or the [source code TAR file.](https://github.com/KatherineMossDeveloper/The-Georgia-Project/archive/refs/tags/v1.5.5.tar.gz) and extract it.  
